...
our %config = (
  ...
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "/mnt/e/repos/android-ndk-r23c-linux/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  openssldir => "",
  options => "--prefix=/mnt/e/repos/libcurl-openssl-android/openssl-1.1.1q/out/arm64 -D__ANDROID_API__=21 no-afalgeng no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.30.0",
  perlargv => [ "--prefix=/mnt/e/repos/libcurl-openssl-android/openssl-1.1.1q/out/arm64", "-D__ANDROID_API__=21", "no-shared", "android-arm64" ],
  perlenv => {
      "AR" => "/mnt/e/repos/android-ndk-r23c-linux/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar",
      "BUILDFILE" => undef,
      "CC" => "/mnt/e/repos/android-ndk-r23c-linux/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang",
      "CFLAGS" => undef,
      "CPPFLAGS" => undef,
      "CROSS_COMPILE" => undef,
      "CXX" => "/mnt/e/repos/android-ndk-r23c-linux/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++",
      ...
      "PERL" => undef,
      "RANLIB" => "/mnt/e/repos/android-ndk-r23c-linux/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
  ...
  prefix => "/mnt/e/repos/libcurl-openssl-android/openssl-1.1.1q/out/arm64",
  processor => "",
